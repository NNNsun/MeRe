...
class CustomAnchorTabPanel extends StatefulWidget {
  ...
  @override
  _CustomAnchorTabPanelState createState() => _CustomAnchorTabPanelState();
}

class _CustomAnchorTabPanelState extends State<CustomAnchorTabPanel> {
